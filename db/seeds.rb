...
sedona = Vacation.create(about:"Located in Az", name:"Sedona", payment_required: false, date_range: "Sept 19 - 22" )
...
beth = User.create(name:"Beth", image_url:"", email_address:"")
...
UserVacation.create(user:beth, vacation: sedona)

Event.create(name:"l'auberge", amount:25, category:"dining", date_of_event: "9/21/2019", vacation_id: 1, user_id: 1)
Event.create(name:"climbing permit", amount:25, category:"Recreation", date_of_event: "9/20/2019", vacation_id: 1, user_id: 2)
Event.create(name:"Airbnb", amount:1700, category:"lodging", date_of_event: "9/19/2019 - 9/21/2019", vacation_id: 1, user_id: 1)
